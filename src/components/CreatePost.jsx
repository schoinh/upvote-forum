...
const CreatePost = (props) => {
  ...
  function handleNewFormPostSubmission(event){
    ...
    console.log("handlenewformpostsubmit: " + _title.value + ", " + _bodyText.value);
    props.handleNewFormPost({title :_title.value, bodyText : _bodyText.value, id : v4()});
    _title.value = '';
    _bodyText.value = '';
...
CreatePost.proptype = {
  handleNewFormPost : PropTypes.string
}
